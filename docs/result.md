...
Написал конфигурацию Terraform для создания
...
- Реализовал использование переменных

![alt text](image-4.png)

- Вынес чувствительные данные в terraform.tfvars.

![alt text](image-5.png)

- Инициализировал бэкенд для хранения состояния
